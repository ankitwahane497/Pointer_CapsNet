...
class CapsLayer(object):
    ...
    def __call__(self, input, kernel_size=None, stride=None, scope = 'caps_layer'):
        '''
        ...
        if self.layer_type == 'CONV':
            ...
            if not self.with_routing:
                ...
                capsules = tf_util.conv2d(input, self.num_outputs * self.vec_len, [1,1],
                               padding='VALID', stride=[1,1],
                               bn=False, scope= scope, is_dist=True)
