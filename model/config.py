...
flags.DEFINE_string('dataset_folder', '/home/sanket/MS_Thesis/Pointer_CapsNet/Dataset/', 'The name of dataset [mnist, fashion-mnist')
flags.DEFINE_string('dataset_file', 'features.npy', 'The name of dataset [mnist, fashion-mnist')
flags.DEFINE_string('labels_file', 'targets.npy', 'The name of dataset [mnist, fashion-mnist')
